...
[QuasarDB](https://www.quasar.ai/why-quasardb/) is a high performance, limitless, time series database built to handle the most demanding use cases.
...
```
grafana-cli --pluginUrl https://github.com/bureau14/qdb-grafana-plugin/archive/3.14.1.zip plugins install qdb-grafana-datasource
```
...
If you have any problems or suggestions please don't hesitate to contact us at [support@quasar.ai](mailto:support@quasar.ai)
